...
export const ChatInfo = ({
    ...
    const hint = useMemo(() => {
        ...
        if (isDelayed && !isFollowersOnly ) return "Messages are delayed by 3 seconds";

        if (isDelayed && isFollowersOnly) return "Only followers can chat. Messages are delayed by 3 seconds";
